...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname grades1) (read-case-sensitive #t) (teachpacks ((lib "image.ss" "teachpack" "htdp"))) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ((lib "image.ss" "teachpack" "htdp")))))
;;; Question 4a
...
(define (final-CS135-grade parti assn mid1 mid2 final)
  (cond
    [(and(< (+ (participation parti)(assignment assn)(* (avg-exam mid1 mid2 final) 0.75)) 46) (< (avg-exam mid1 mid2 final) 50)) (+ (participation parti)(assignment assn)(* (avg-exam mid1 mid2 final) 0.75))]
    [(and(< (+ (participation parti)(assignment assn)(* (avg-exam mid1 mid2 final) 0.75)) 46) (< assn 50)) (+ (participation parti)(assignment assn)(* (avg-exam mid1 mid2 final) 0.75))]
    [(< (avg-exam mid1 mid2 final) 50) 46]
    [(and(> (+ (participation parti)(assignment assn)(* (avg-exam mid1 mid2 final) 0.75)) 46) (< assn 50)) 46]
    [(and(> (+ (participation parti)(assignment assn)(* (avg-exam mid1 mid2 final) 0.75)) 46) (< (avg-exam mid1 mid2 final) 50)) 46]
